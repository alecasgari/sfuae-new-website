...
<body>
    ...
    <div id="scrollsmoother-container">
        ...
        <section>
            ...
            <!-- start image our agency story -->
            <div class="container">
                <div class="cs_agency agency_about_images_posation">
                    <div class="cs_img_section_1">
                        <img src="assets/img/agency_story_1.png" alt="" class="w-100" />
                    </div>
                    <div class="cs_img_section_2">
                        <img src="assets/img/agency_story_2.png" alt="" class="w-100" />
                    </div>
                    <div class="cs_img_section_3">
                        <div class="text-end">
                            <img src="assets/img/agency_story_4.png" alt="" />
                            <img src="assets/img/agency_story_3.png" class="w-100" alt="" />
                        </div>
                    </div>
                </div>
            </div>
            <!-- end image our agency story -->
        </section>
        <!-- end our agency story -->
        ...
        <section>
            <div class="container">
                <div class="cs_section_heading cs_style_1 cs_type_1">
                    <div class="cs_section_heading_text">
                        <div class="cs_section_subtitle anim_div_ShowZoom">Gallery</div>
                        <h2 class="cs_section_title anim_heading_title">
            ...
            <div class="cs_slider cs_slider_6">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <img src="assets/img/about_gallery_1.png" class="card-img" alt="..." />
                    </div>
                    <div class="swiper-slide">
                        <img src="assets/img/about_gallery_2.png" class="card-img" alt="..." />
                    </div>
                    <div class="swiper-slide">
                        <img src="assets/img/about_gallery_3.png" class="card-img" alt="..." />
                    </div>
                    <div class="swiper-slide">
                        <img src="assets/img/about_gallery_1.png" class="card-img" alt="..." />
                    </div>
