...
<?php include 'header.php'; ?>
    ...
    <div id="scrollsmoother-container">
                ...
                <div class="cs_text_hero">
                    ...
                    <div class="cs_text_section_2">
                        ...
                        <p class="cs_detils_text cs_mp0 anim_subtext">
                            ...
                            online. From website design and development to digital marketing and advertising, we have
                            the tools.
                        </p>
                    </div>
                </div>
        ...
        <!-- Start Innovative Solutions for Modern Digital Needs -->
        <section>
            <div class="container">
                <div class="cs_modern_needs cs_style">
                    <div class="cs_col_md_778">
                        <div class="cs_text">
                            <div class="cs_section_heading cs_style_1">
                                <div class="cs_section_heading_text">
                                    <h2 class="cs_section_title anim_heading_title">
                                        Innovative Solutions for Modern Digital Needs
                                    </h2>
                                </div>
                            </div>
                            ...
                            <p class="anim_text">
                                Welcome to our digital agency! We specialize in helping businesses like yours succeed
                                online. From website design and development to digital marketing and advertising,
                            </p>
                        </div>
                        ...
                        <div class="row anim_div_ShowLeftSide">
                            <div class="col-md-4 col-12">
                                ...
                                <div class="text-section">
                                    <h6>Ideation</h6>
                                    <p>Digital of the day Mobile app excellence</p>
                                </div>
                            </div>
                            <div class="col-md-4 col-12">
                                <div class="cs_stroke_text">
                        ...
                        <div class="cs_img_section">
                            ...
                            <div class="cs_img_card_text anim_div_ShowZoom">
                                ...
                                <p>
                                    ...
                                    succeed Well come to our digital agency
                                </p>
                            </div>
                        </div>
                    </div>
        ...
        <!-- End Innovative Solutions for Modern Digital Needs -->
        <div class="cs_height_150 cs_height_lg_60"></div>
        <!-- Start Moving Text -->
                    ...
                    <div class="col-lg-8 col-12">
                        <div class="cs_section_heading cs_style_1">
                            <div class="cs_section_heading_text">
                                ...
                                <h2 class="cs_section_title anim_heading_title">
                                    Elevating Your Business to the Next Level Expertise in Startup Agency Services
                                </h2>
                            </div>
                        </div>
                        <div class="cs_height_70"></div>
                        <div class="d-flex gap-4 align-items-center flex-wrap flex-lg-nowrap justify-content-center">
                            <div class="anim_text">
                                <p class="cs_font_16 cs_secend_section">
                                    ...
                                    advertising, we have the tools. From website design and development to digital
                                    marketing and advertising,
                                    we have the toolsis. From website design and development. Welcome to our digital
                                    agency.
                                </p>
                                <div class="cs_service_back_btn">
                                    <a href="" class="cs_style_1 cs_color_1">
                            ...
                            <div class="cs_startup_agency cs_card cs_mr_left">
                                ...
                                <p class="cs_font_16 cs_mp0">
                                    Digital of the day Mobile app excellence
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                ...
                <div class="cs_section_heading cs_style_1 cs_color_1 cs_type_1">
                    <div class="cs_section_heading_text">
                        ...
                        <h2 class="cs_section_title anim_heading_title">
                            Comprehensive Digital Services & Transformation
                        </h2>
                    </div>
                </div>
                <!-- end heading -->
                                    ...
                                    <div class="cs_card_right">
                                        <div class="cs_card_right_in">
                                            <h2 class="cs_card_title">
                                                <a href="service-details.html" class="cs_white_color">
                                                    <span>01 /</span> UI/UX Design</a>
                                            </h2>
                                        </div>
                                    </div>
                                    <div class="cs_card_link_wrap">
                                        <a href="service-details.html" class="cs_card_link cs_white_color">
                                            <span>
                            ...
                            <div class="cs_creative_protfolio cs_card_style_change">
                                <div class="cs_card cs_style_1 cs_color_1">
                                    <div class="cs_card_right">
                                        <div class="cs_card_right_in">
                                            <h2 class="cs_card_title">
                                                <a href="service-details.html" class="cs_white_color"><span>02 /</span>
                                                    Branding Design</a>
                                            </h2>
                                        </div>
                                    </div>
                            ...
                            <div class="cs_creative_protfolio cs_card_style_change">
                                <div class="cs_card cs_style_1 cs_color_1">
                                    <div class="cs_card_right">
                                        <div class="cs_card_right_in">
                                            <h2 class="cs_card_title">
                                                <a href="service-details.html" class="cs_white_color"><span>03 /</span>
                                                    Marketing Asset</a>
                                            </h2>
                                        </div>
                                    </div>
                            ...
                            <div class="cs_creative_protfolio cs_card_style_change">
                                <div class="cs_card cs_style_1 cs_color_1">
                                    <div class="cs_card_right">
                                        <div class="cs_card_right_in">
                                            <h2 class="cs_card_title">
                                                <a href="service-details.html" class="cs_white_color"><span>04 /</span>
                                                    Development</a>
                                            </h2>
                                        </div>
                                    </div>
                            ...
                            <div class="cs_creative_protfolio cs_card_style_change">
                                <div class="cs_card cs_style_1 cs_color_1">
                                    <div class="cs_card_right">
                                        <div class="cs_card_right_in">
                                            <h2 class="cs_card_title">
                                                <a href="service-details.html" class="cs_white_color"><span>05 /</span>
                                                    Creative Art</a>
                                            </h2>
                                        </div>
                                    </div>
        ...
        <section>
            <div class="container">
                <div class="cs_section_heading cs_style_1 cs_type_1 swiper-slide swiper-slide-active">
                    <div class="cs_section_heading_text">
                        <div class="cs_section_subtitle anim_divShowZoom">
                            Our Awards
                        </div>
                        <h2 class="cs_section_title anim_heading_title">
