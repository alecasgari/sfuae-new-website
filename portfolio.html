...
<body>
    ...
    <div id="scrollsmoother-container">
        ...
        <!--Start Some Recent Project Titel  -->
        <section>
            <div class="container">
        ...
        <!--End Some Recent Project Titel  -->
        <div class="cs_height_50 cs_height_lg_25"></div>

        <!-- Start Some Recent Project Show -->
        <section class="cs_ui_design">
            <div class="container">
                <div>
                    <div class="row">
                ...
                <div>
                    <div class="cs_hero_btn_wrap text-center">
                        <div class="cs_round_btn_wrap">
                            <a href="#" class="cs_hero_btn cs_round_btn btn-item"><span></span> Load More</a>
                        </div>
                    </div>
                </div>
            </div>
        </section>
        <!-- End Some Recent Project Show -->
