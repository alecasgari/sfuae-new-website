                    ...
                    <div class="cs_contact">
                        <div class="cs_contact_text">
                            ...
                            <h1 class="cs_contact_title anim_text_writting">
                                Get in Touch with Spring Future
                            </h1>
                        </div>
                        <div class="cs_height_80 cs_height_lg_20"></div>
                        <div class="cs_from anim_div_ShowDowns">
                            <form id="contactForm"> <div class="row">
                                    <div class="cs_field_group col">
                                        <input class="cs_input_field" type="text" id="form_name" placeholder="Name"
                                            name="name" required /> <label for="form_name" class="cs_input_label">Name*</label>
                                    </div>
                                    <div class="cs_field_group col">
                                        <input class="cs_input_field" type="email" id="form_email" placeholder="Email"
                                            name="email" required /> <label for="form_email" class="cs_input_label">Email*</label>
                                    </div>
                                </div>
                                <div class="cs_height_10 cs_height_lg_20"></div>
                                <div class="row">
                                    <div class="cs_field_group col">
                                        <input class="cs_input_field" type="tel" id="form_phone" placeholder="Phone"
                                            name="phone" /> <label for="form_phone" class="cs_input_label">Phone</label>
                                    </div>
                                    <div class="cs_field_group col">
                                        <input class="cs_input_field" type="text" id="form_subject" placeholder="Subject"
                                            name="subject" required /> <label for="form_subject" class="cs_input_label">Subject*</label>
                                    </div>
                                </div>
                                <div class="cs_height_100 cs_height_lg_60"></div>
                                <div class="cs_field_group">
                                    <textarea class="cs_input_field" id="form_message" placeholder="Your Message"
                                        name="message" rows="5" required></textarea> <label for="form_message" class="cs_input_label">Message*</label>
                                </div>
                                <div class="cs_height_60 cs_height_lg_60"></div>
                                <button type="submit" class="cs_btn cs_style_1 cs_type_btn">
                                    <span>Send Message</span> <svg width="19" height="13" viewBox="0 0 19 13" fill="none"
                                ...
                                <div id="formStatus" class="cs_height_20"></div> </form>
                        </div>
                    </div>
                    <div class="cs_contact_section_2 anim_div_ShowRightSide">
                        <div class="cs_google_map cs_bg" data-src="<?php echo $base_path; ?>assets_new/img/dubai_map_placeholder.jpg">
                            <iframe
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="cs_icon">
                                    <a href="https://goo.gl/maps/YOUR_GOOGLE_MAPS_SHARE_LINK" target="_blank" class="cs_icon_style"> <i>
                                      ...
                                      8.52418 8.92986 10.0195 7 10.0195Z" fill="currentColor"></path> </svg>
                                        </i>
                                    </a>
                                    <div class="cs_icon_text">
                                        <h6 class="cs_icon_title">Our Address</h6>
                                        <p class="cs_icon_subtitle">
                                            Office 707, Building 10, <br/>Bay Square, Business Bay, <br/>Dubai, UAE
                                        </p>
                                        <p class="cs_icon_subtitle" style="margin-top: 5px;"><em>Mon – Fri: 9:00 AM – 6:00 PM</em></p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="cs_icon">
                                    <a href="tel:+971504302948" class="cs_icon_style">
                                        <i>
                                    ...
                                    <div class="cs_icon_text">
                                        <h6 class="cs_icon_title">Call Us</h6>
                                        <p class="cs_icon_subtitle">+971 50 430 2948</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="cs_icon">
                                    <a href="mailto:info@sfuae.co" class="cs_icon_style">
                                        <i>
                                    ...
                                    <div class="cs_icon_text">
                                        <h6 class="cs_icon_title">Email Us</h6>
                                        <p class="cs_icon_subtitle">info@sfuae.co</p>
                                    </div>
                                </div>
                            </div>
                        </div>
